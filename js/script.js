document.addEventListener('DOMContentLoaded', function() {
    ...
    if (menuToggle) {
        menuToggle.addEventListener('click', function(e) {
            ...
            if (navMenu.classList.contains('active')) {
                ...
                // Change menu icon to close with animation
                ...
                // اضافه کردن تشخیص کلیک خارج از منو برای بستن آن
    ...
    // Function to close the mobile menu with advanced animations
    function closeMenu() {
        if (navMenu && navMenu.classList.contains('active')) {
            
            // Reset menu item animations with sequence
            const menuItems = navMenu.querySelectorAll('.nav-item');
            menuItems.forEach((item, index) => {
                item.style.transitionDelay = (0.05 * (menuItems.length - index - 1)) + 's';
                item.style.opacity = '0';
                item.style.transform = 'translateX(20px)';
                
                // ریست انیمیشن آیکون‌ها
            ...
            // Change menu icon back with animation
            const menuIcon = menuToggle.querySelector('i');
            if (menuIcon) {
                menuIcon.style.transform = 'rotate(90deg) scale(0.5)';
                setTimeout(() => {
            ...
            // Remove active class from menu after animation completes
            setTimeout(() => {
    ...
    // اضافه کردن پشتیبانی از کلید Escape برای بستن منو
    ...
    navItems.forEach(item => {
        item.addEventListener('click', function(e) {
            ...
            // تنظیم سایز ریپل بر اساس بزرگترین بعد المان
            ...
            // اضافه کردن ریپل به المان
            this.appendChild(ripple);
            
            // حذف ریپل بعد از اتمام انیمیشن
            setTimeout(() => {
                ripple.remove();
            }, 600);
        });
